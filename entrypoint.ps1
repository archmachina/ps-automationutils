...
Invoke-CIProfile -Name $Profile -Steps @{
    ...
    build = @{
        Steps = {
            ...
            Write-Information "Templating AutomationUtils.psd1"
            Format-TemplateFile -Template source/AutomationUtils.psd1.tpl -Target source/AutomationUtils/AutomationUtils.psd1 -Content @{
            ...
            Install-PSModuleFromManifest -ManifestPath source/AutomationUtils/AutomationUtils.psd1

            # Test the module manifest
            Write-Information "Testing module manifest"
            Test-ModuleManifest source/AutomationUtils/AutomationUtils.psd1

            # Import modules as test
            Write-Information "Importing module"
            Import-Module ./source/AutomationUtils/AutomationUtils.psm1
        }
    }
    ...
    release = @{
        Steps = "build", {
            ...
            Publish-Module -Path ./source/AutomationUtils -NuGetApiKey $Env:NUGET_API_KEY
        }
    }
}
